...
public class Betaaloverzicht {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(String.format("De verkoopprijs van een appel is: %s\n" +
        ...
        System.out.println(String.format("Aantal appels: %13s\n" +
        ...
        System.out.println(String.format("Aantal peren: %14s\n" +
                        "Totaal kostprijs: %10.2f\n" +
                        "Totaal BTW: %16.2f\n" +
                        "Subtotaal omzet: %11.2f\n",
                amountOfApples,
        ...
        System.out.println(String.format("Aantal aardappels: %9s\n" +
                        "Totaal kostprijs: %10.2f\n" +
                        "Totaal BTW: %16.2f\n" +
                        "Subtotaal omzet: %11.2f\n",
                amountOfApples,
        ...
        System.out.println(String.format("Totale omzet incl. BTW: %.2f\n" +
                        "Totale BTW: %16.2f",
